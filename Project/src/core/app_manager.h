...
{
private:
    static std::vector<AppInfo> cachedApps;
    static bool appsCacheValid;
public:
    /**
     ...
     */
    static std::vector<AppInfo> listInstalledApps();
     ...
     */
    static std::string listInstalledAppsAsCSV();
     ...
     */
    static bool startApp(const std::string &appPath, const std::string &arguments = "");
